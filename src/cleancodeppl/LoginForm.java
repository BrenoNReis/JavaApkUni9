...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelLoginForm.setText("Login de Usuário");
        ...
        jPasswordField.setText("nomedeusuario");
        ...
        jLabelLoginForm1.setText("Autenticação de Usuário");
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        ...
        if (uname.equals("test") && psswd.equals("test")) {
            ...
            JOptionPane.showMessageDialog(LoginForm.this, "Usuário Logado (Por favor reiniciar o projeto)");
        }
